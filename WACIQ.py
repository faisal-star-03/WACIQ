...
print(banner)
print("\033[1;31m[ PyMenu v1.0 ]  \033[1;37m(By Jaber)\n")
...
menu_left = [
    ...
    "04  Messenger",
    "05  Instagram Traditional",
    "06  Insta Auto Followers",
    "07  Gmail Old",
    "08  Gmail New",
    "09  Microsoft",
    "10  Netflix",
...
for l, m, r in zip(menu_left, menu_middle, menu_right):
    print(f"{RED}{l:<25}{GREEN}{m:<25}{YELLOW}{r:<25}{RESET}")

print(RED + "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n" + RESET)

# Footer Options
print("\033[1;35m[a] About     \033[1;36m[s] Saved     \033[1;32m[x] More Tools     \033[1;31m[0] Exit\n")

choice = input("\033[1;33m[?] Select one of the options: \033[0m")
print(f"\n\033[1;32m[✓] You selected: {choice}\033[0m") 
...
choice = input("\033[1;33m[?] Select one of the options: \033[0m") 
print(f"\n\033[1;34m[✓] You selected option {choice}\033[0m") 
def Jaber():
    os.system('clear')
