...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;34m    : [★] WACIQ x JABER ARMY\033[1;39m   ┃  
...
def WACIQ():  
    ...
    print("\033[1;96m ╚═════════════════════════════════╝")  
    print("")  
    choice = input(f'\033[1;32m ՏᎬᏞᎬᏟͲᎬᎠ ƳϴႮᎡ ϴᏢͲᏆϴΝ :\033[1;36m ')  
    if choice in ["1","A"]:  
        WACIQs()  
    if choice in ["2","B"]:  
        os.system('xdg-open https://facebook.com/groups/544684501030088/')  
...
def WACIQs():  
    ...
    with ThreadPool(max_workers=40) as Fb_crack:  
        ...
        print(f'\033[1;91m║\033[1;92م ƳϴႮᎡ ͲϴͲᎪᏞ ᏆᎠ : '+tl)  
        print(f'\033[1;91m║\033[1;92m MACK BY WACIQ x TANJID ')  
        print("\033[1;91m╚═════════════════════════════════════╝")  
        for love in user:  
    ...
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM WACIQ ')  
    print("\033[1;91m╚═══════════════════════════╝") 
