...
# لوی لوگو ښکاره کول (ستاسو ورکړل شوی متن)
def show_waciq():
    waciq_art = [
        "██╗    ██╗ █████╗  ██████╗██╗ ██████╗   ",
        "██║    ██║██╔══██╗██╔════╝██║██╔═══██╗  ",
    ...
    for line in waciq_art:
        print(line.center(cols))
        time.sleep(0.05)

    # ځلا (blink) افکت
    for _ in range(3):
        print("\033[1;93m" + "WACIQ".center(cols) + "\033[0m")
        time.sleep(0.3)
        print(" ".center(cols))
        time.sleep(0.3)
...
# لوگو او معلومات
logo = """\033[1;31m
┏━━━━━━━━━━━━━━━━━━━\033[38;5;46mBCS\033[1;39m━━━━━━━━━━━━━━━━━━━━━┓
┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\033[1;34m        : [★] JABER\033[1;39m            ┃
┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;34m    : [★] JABER x JABER ARMY\033[1;39m   ┃
┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\033[1;34m      : [★] J x T ARMY\033[1;39m          ┃
┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉\033[1;34m  : [★]𝗕𝗔𝗡𝗚𝗟𝗔𝗗𝗘𝗦𝗛𝗜\033[1;39m        ┃
┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋\033[1;34m    : [★]+8801852192547\033[1;39m     ┃
┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙏𝙊𝙊𝙇𝙎 𝙉𝘼𝙈𝙀\033[1;34m  : [★]𝗥𝟰𝗡𝗗𝗢𝗡-𝗖𝗟𝗢𝗡𝗜𝗡𝗚\033[1;39m     ┃
┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙏𝙊𝙊𝙇𝙎 𝙎𝙏𝘼𝙏𝙐𝙎\033[1;34m: [★]free\033[1;39m               ┃
┗━━━━━━━━━━━━━━━━━━━\033[1;31mTEAM\033[1;39m━━━━━━━━━━━━━━━━━━━━┛
"""
