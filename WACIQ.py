...
ascii_message = r"""
__   __            _                           _                 _     
\ \ / /__  _   _  | | ___ __   _____      __ | |__   ___  _   _| |_   
 \ V / _ \| | | | | |/ / '_ \ / _ \ \ /\ / / | '_ \ / _ \| | | | __|  
  | | (_) | |_| | |   <| | | | (_) \ V  V /  | |_) | (_) | |_| | |_   
  |_|\___/ \__,_| |_|\_\_| |_|\___/ \_/\_/   |_.__/ \___/ \__,_|\__|  

 __        ___    ____ ___   ____   _  __ _____ _   _  ____  
 \ \      / / \  / ___|_ _| / ___| | |/ /|_   _| | | |/ ___| 
  \ \ /\ / / _ \ \___ \| | | |     | ' /   | | | |_| | |  _  
   \ V  V / ___ \ ___) | | | |___  | . \   | | |  _  | |_| | 
    \_/\_/_/   \_\____/___| \____| |_|\_\  |_| |_| |_|\____| 
...
def display_all_sections():
    os.system("clear")
    type_print(tri(logo_main), 0.002)
    ...
    for idx, name in enumerate(names):
        ...
        for i in range(8):
            L = items[i].ljust(box_width)
            Rg = items[i+8].ljust(box_width)
            type_print(tri(f"▒{L}│{Rg}▒"), 0.003)
